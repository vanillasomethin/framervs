...
const COMPONENT_CONFIG: Record<string, {
  ...
  civilQuality: {
    ...
    // Shown at its effective contribution to the "core" bucket (engine applies
    // ×0.15 here since the bulk of the quality jump is already priced via the
    // structural shell multiplier on base construction cost, shown separately).
    pricing: { standard: 45, premium: 72, luxury: 117 }
  },
  plumbing: {
    ...
    pricing: { standard: 500, premium: 800, luxury: 1300 }
  },
  electrical: {
    ...
    pricing: { standard: 400, premium: 640, luxury: 1040 }
  },
  ac: {
    ...
    pricing: { standard: 800, premium: 1300, luxury: 2100 }
  },
  elevator: {
    ...
    pricing: { standard: 750, premium: 1200, luxury: 1950 }
  },
  buildingEnvelope: {
    ...
    pricing: { standard: 150, premium: 240, luxury: 390 }
  },
  waterproofing: {
  ...
  ceiling: {
    ...
    pricing: { standard: 350, premium: 560, luxury: 910 }
  },
  surfaces: {
    ...
    pricing: { standard: 600, premium: 1000, luxury: 1700 }
  },
  fixedFurniture: {
    ...
    pricing: { standard: 3000, premium: 5400, luxury: 9000 }
  },
  looseFurniture: {
    ...
    pricing: { standard: 2000, premium: 3600, luxury: 6500 }
  },
  furnishings: {
    ...
    pricing: { standard: 500, premium: 1000, luxury: 1800 }
  },
  appliances: {
    ...
    pricing: { standard: 1000, premium: 2000, luxury: 3800 }
  },
  artefacts: {
    ...
    pricing: { standard: 300, premium: 900, luxury: 2000 }
  },
};
